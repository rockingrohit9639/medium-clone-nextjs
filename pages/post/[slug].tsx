      ...
      {submitted ? (
        <div className="flex flex-col p-10 my-10 bg-yellow-500 text-white max-w-2xl mx-auto">
          <h3 className="text-3xl font-bold">
            Thank you for submitting your valuable comment!
          </h3>
          <p>Once it have beed approved, it will appear below!</p>
        </div>
      ) : (
        <form
        ...
        >
          ...
          <label className="block mb-5">
            ...
            <textarea
              ...
              placeholder="Your thought about the post"
              rows={8}
            ></textarea>
          </label>
          ...
          <input
            type="submit"
            className="shadow bg-yellow-500 cursor-pointer hover:bg-yellow-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 rounded"
          />
        </form>
      )}
